...
import gravitational.Simulation5Jupiter;
...
public class EJ3c {
    ...
    public static void main(String[] args) throws IOException {
        ...
        fileWriter = new FileWriter("datos6p4Jupiter.csv", false);
        ...
        while(i<end){
            ...
            Simulation5Jupiter simulation = new Simulation5Jupiter("output.txt",dt,tf,lounchPctg,sun,earth,mars,jupiter,saturn,spaceshipVel);
